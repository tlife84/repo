...
12. Open a terminal, browse to a convenient location for your project, and type `git clone https://github.com/tlife84/myreponame.git`, replacing the `https://github.com/tlife84/myreponame.git` with your repository's https clone URL that you copied.
...
Github Pages will now automatically build your site. Wait a minute or two, and then visit tlife84.github.io/yourreponame, replacing this path with your github account and branch.
